...
public class AudioManager implements Updatable {
    ...
    public static void initialize() {
        ...
        instance.ambient = new SoundGroup(instance.audio,
                new String[] { "ambient.wav" },
                20, true, 2000, 0f,false
        );
