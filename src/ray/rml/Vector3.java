...
/**
 * A 3-component {@link Vector vector}.
 * <p>
 ...
 *
 */
public interface Vector3 extends Vector<Vector3>, ThreeDimensional, Crossable<Vector3>,
        AngleAxisRotatable<Vector3, Vector3> {
     ...
     * {@link Vector3 vector}.
     *
     * @return A new {@link Vector2} instance from <code>this</code> {@link Vector3
     *         vector}.
     */
    Vector2 toVector2();

    /* MyChange: added conversion function */
    javax.vecmath.Vector3f toJavaX();
}
